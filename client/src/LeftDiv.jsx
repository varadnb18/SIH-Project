    ...
    return (
        <div className="LeftDiv">
            ...
            <div className="group_button_left">
                ...
                <input type="text" className="button_leftside" placeholder="Insert PH of Soil" onChange={(e)=>setPh(e.target.value)} />
                <input type="text" className="button_leftside" placeholder="Insert Sulfur Presence (mg/kg)" onChange={(e)=>setSulfur(e.target.value)} />
                <input type="text" className="button_leftside" placeholder="Insert Nitrogen Presence (mg/kg)" onChange={(e)=>setNitrogen(e.target.value)} />
                <input type="text" className="button_leftside" placeholder="Insert Potassium Presence (mg/kg)" onChange={(e)=>setPotassium(e.target.value)} />
            </div>
